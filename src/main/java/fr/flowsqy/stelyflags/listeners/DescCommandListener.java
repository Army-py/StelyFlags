...
public class DescCommandListener implements Listener {

    public DescCommandListener(Plugin plugin) {
        Bukkit.getPluginManager().registerEvents(this, plugin);
    }

    @EventHandler(priority = EventPriority.HIGHEST)
    public void onDescCommand(PlayerCommandPreprocessEvent event) {
        ...
        if (!set.isMemberOfAll(player) && !set.testState(player, StelyFlags.USE_DESCEND_COMMAND)) {
